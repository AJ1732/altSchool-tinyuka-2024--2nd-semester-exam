...
function RouteComponent() {
  ...
  const pageTitle = `${title} - ${status} Task | TODOS`;
  const pageDescription = `Task "${title}" is currently ${status.toLowerCase()}. ${userName ? `Assigned to ${userName}.` : ""} Manage and track your todo items efficiently.`;
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content={`todo, task, ${status.toLowerCase()}, ${title}, task management, productivity`}
        />
